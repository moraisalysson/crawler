...
def atualizarPolaridade(idPalavra_polaridade, polaridade):
    ...
    cursor.execute('update palavra_polaridade SET pol_OpLexicon_2 = %s WHERE idpalavra_polaridade = %s', (polaridade, idPalavra_polaridade))
...
def inserePalavraPolaridade(idpalavra, polaridade):
    ...
    cursor.execute('insert into palavra_polaridade(idpalavra, pol_OpLexicon_2) values(%s, %s)', (idpalavra, polaridade))
    idpalavra_polaridade = cursor.lastrowid
