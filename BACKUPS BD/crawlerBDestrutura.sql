...
CREATE TABLE `noticias_score` (
  ...
  `polaridade_LIWC` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polaridade_OpLexicon` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polaridade_ReLiLex` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polaridade_Sentilex` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polaridade_WordnetBr` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=21531 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=7346461 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=83893 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `urls` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=21531 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'indice'
--

--
-- Dumping routines for database 'indice'
--
...
-- Dump completed on 2021-04-05 19:27:07
